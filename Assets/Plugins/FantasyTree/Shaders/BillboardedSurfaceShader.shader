Shader "FantasyTree/BillboardedSurface"
{
    ...
    _BaseColorMultiplier("_BaseColorMultiplier" , Range(0,1)) = .5
    _TipColorMultiplier("_TipColorMultiplier" , Range(0,1)) = .5
    ...
    // little randomness funciton
      float hash( float n ){
        ...
        float _AmountShown;
          ...
          float4 _BaseColor;
          float4 _BaseColorMultiplier;
          float4 _TipColor;
          float4 _TipColorMultiplier;
          int _SpriteSize;
        half _Glossiness;
        half _Metallic;
